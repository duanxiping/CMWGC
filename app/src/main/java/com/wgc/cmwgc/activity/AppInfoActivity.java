...
public class AppInfoActivity extends AppCompatActivity {
    ...
    private boolean JT808DefualtHeartBeat = false;
    //经纬度
...
//            }else if (intent.getAction().equals("MY_JT808_Defualt_HEARTbeat")) {
//                Log.w(TAG, "收到JT808 服务广播 ：" + " -- " + WebSocketHeartBeat);
//                JT808DefualtHeartBeat = intent.getBooleanExtra("jt_defualt_heart", false);
            }
