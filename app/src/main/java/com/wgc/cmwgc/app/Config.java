...
//	public static final String UPDATA_APK_URL = "http://o.bibibaba.cn/upgrade?app_name=wgc_rearview_jt808";
	...
	public static String SPEED_LIMIT_D = "speed_limit_d";//默认链路限制速度
	public static String SPEED_LIMIT_B = "speed_limit_b";//部标链路限制速度
	...
	/*超速和围栏 广播*/
	public static final String SPEED_ENCLOSURE_DEFAULTSERVER = "My_SpeedEnclosureService_Broadcast_DefaultServer";
	public static final String SPEED_ENCLOSURE_BEIDOUSERVICE = "My_SpeedEnclosureService_Broadcast_BeiDouService";
	public static final String ALARMKEY = "com.android.internal.policy.impl.alarmkey";

	//车连连的ACC广播
	public static final String CAR_SIGNAL= "carsignal";
