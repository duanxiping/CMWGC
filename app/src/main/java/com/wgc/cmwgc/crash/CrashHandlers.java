package com.wgc.cmwgc.crash;
  ...
  import com.wgc.cmwgc.Until.crashutil.DateUtil;
  import com.wgc.cmwgc.Until.crashutil.FileUtil;
...
public class CrashHandlers implements UncaughtExceptionHandler {
    ...
    /** 保证只有一个CrashHandlerss实例 */
    private CrashHandlers() {
    }

    /** 获取CrashHandlerss实例 ,单例模式 */
